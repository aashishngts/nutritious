        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-14">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-full bg-[#138f44]/20 flex items-center justify-center text-[#138f44] text-xl"><img
...
/></div>
  ...
  {[
    ...
    <li key={i}>
      <a href={link.path} className="hover:text-[#86efac] transition duration-300">
        {link.name}
      </a>
    </li>
  ))}
