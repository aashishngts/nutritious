        ...
        <div className="max-w-8xl mx-auto md:px-10 px-4 sm:px-6 lg:px-14">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              {/* ✅ Appointment Button (Modal Open) */}
              <button
                onClick={() => setOpenAppointment(true)}
                className="flex items-center space-x-2 bg-green-500 text-white px-5 py-2 rounded-full hover:bg-green-600 transition-all duration-300"
              >
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
